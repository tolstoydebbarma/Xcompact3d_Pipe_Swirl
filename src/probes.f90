    ...
    if (flag_extra_probes) then
       ...
       do is = 1, numscalar
          ...
          if (evensc) then
             ...
             call deryS (tc2,phi2(:,:,:,is),di2,sy,ffyS,fsyS,fwyS,ppy,ysize(1),ysize(2),ysize(3),0)
             call derzS (tb3,phi3(:,:,:,is),di3,sz,ffzS,fszS,fwzS,zsize(1),zsize(2),zsize(3),0)
          endif
