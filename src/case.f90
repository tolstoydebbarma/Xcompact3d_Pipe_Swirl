...
CONTAINS
  ...
  SUBROUTINE postprocess_case(rho,ux,uy,uz,pp,phi,ep)
    ...
    ELSEIF (itype.EQ.itype_pipe) THEN
	   ...
	   CALL postprocess_pipe_extra(ux,uy,uz,ep)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  SUBROUTINE momentum_forcing(dux1, duy1, duz1, rho1, ux1, uy1, uz1, ep1)
    ...
    IF (itype.EQ.itype_channel) THEN
       ...
       CALL momentum_forcing_channel(dux1, duy1, ux1, uy1, ep1)
